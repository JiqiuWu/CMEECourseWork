...
# Type your code here:
list1 = subprocess.Popen(["ls"], stdout=subprocess.PIPE)
list2 = subprocess.Popen("grep ^C", stdin=p1.stdout,
                      stdout=subprocess.PIPE, shell=True)
stdout = list2.communicate()[0]
list1.stdout.close()
print(stdout.decode())
...
#studied from Xiaosheng, and need further more comprehension